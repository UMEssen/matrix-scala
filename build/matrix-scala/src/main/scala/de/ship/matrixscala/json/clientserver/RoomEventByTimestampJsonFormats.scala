...
object RoomEventByTimestampJsonFormats {

  implicit val GetEventByTimestampOKFormat: RootJsonFormat[GetEventByTimestamp.OK] = jsonFormat2(
    GetEventByTimestamp.OK.apply
  )
